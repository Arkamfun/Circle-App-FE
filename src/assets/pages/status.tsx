...
import { StatusCards } from "../../features/home/components/statusCards";
import { ArrowBackIcon } from "@chakra-ui/icons";
import { useEffect } from "react";
import { useNavigate, useParams } from "react-router-dom";
import { useReply } from "../../features/home/hooks/use-reply";
import { usethreadDetail } from "../../features/home/hooks/useThreadDetail-hook";
import { useGetReplies } from "../../features/home/hooks/get-reply-hook";
export default function Status() {
  ...
  const FileImage = (props: IconProps) => (
    <Icon viewBox="0 0 576 512" fill="#04A51E" {...props}>
  ...
  // use reply
  const { register, handleSubmit, onSubmit, setValue } = useReply();
  const { data } = useGetReplies();
  console.log("ini datas", data);
  useEffect(() => {
    setValue("threadId", Number(threadId));
  }, [threadId]);

  console.log("ini data dari UI get reply", data);
  return (
    <>
      <Container
        minH={"100vh"}
      ...
      >
        ...
        <Timeline>
          ...
          >
            ...
            {/* ini start comment map */}
            {data?.map((data: ReplyEntity) => (
            ...
            >
              ...
              <Box display={"flex"} flexDirection={"column"} w={"100%"}>
                ...
                <Box>
                  ...
                  <Box w={"35rem"} h={"40rem"}>
                    <Image
                      src="https://images.unsplash.com/photo-1604866830893-c13cafa515d5?q=80&w=2574&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                      h={"100%"}
                      w={"100%"}
                      objectFit={"cover"}
                    />
