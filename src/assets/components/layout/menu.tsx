...
import { useLogout } from '../../../features/auth/hooks/hook-logout';
...
const Navigate = useNavigate()    
    ...
    <Box display={"flex"} flexDirection={"column"} gap={"2rem"} my={"2rem"}>
        ...
        <Box>
            <Link color={"white"} textAlign={"end"} textDecoration={"underline"} onClick={logout} _hover={{fontWeight:"bold",color:"#04A51E"}} cursor={"pointer"}>Logout</Link>
        </Box>
    </Box>
